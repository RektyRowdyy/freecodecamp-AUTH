        ...
        <div className="relative w-full h-[3rem] bg-slate-900 font-mono">
            <div className="mx-auto flex items-center justify-between px-3 py-1.5">
                <div className="inline-flex items-center -ml-4">
                    ...
                    <input disabled={true}
                        class="flex h-8 w-[500px] bg-gray-600 px-3 py-1 text-lg font-medium font-sans placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
